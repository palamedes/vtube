...
The Python half of vtube. It receives face tracking from the iPhone (Live Link Face) or tracks a webcam with MediaPipe, records the microphone, saves takes, and serves the Studio and the character pages over HTTP and WebSocket.
